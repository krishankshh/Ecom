...
<div id="container">
	<div class="nav">
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Walk It Out
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Walk It Out Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
						...
						<li>Upon receiving your product we will charge for delivering for only 150 rupees, depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Online Shoe Store Inc. 2022 Brought To You by <a href="instagram.com/krishankshh">Krishank Shah</a></p>
		</div>
			...
			<div id="develop">
				<h4>Developed By:</h4>
					<ul>
						<a href="#"><li>Krishank Shah (1991051)</li><a>
					</ul>
			</div>
	</div>
</body>
