...
<div id="container">
	<div class="nav">
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The Walk It Out Incorporated respect the privacy of the visitors
					to the Walk It Out.com website and the local websites connected with it, and take great care to protect your
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While Walk It Out strives to protect its user's
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Walk It Out Inc. 2022 Brought To You by <a href="instagram.com/krishankshh">Krishank Shah</a></p>
		</div>
